...
export default function ProfessionalBatchClientsPage() {
        ...
        <Card className="bg-white border border-slate-200 shadow-sm p-8">
          <CardContent>
            ...
            <Typography variant="lead" className="text-slate-600 text-center mb-8">
              PROFESSIONAL Plan: Up to 15 clients, 75 reports per month
            </Typography>
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <Typography variant="body" className="text-slate-700 text-sm">
                    <strong>PROFESSIONAL Plan - 14-Day Free Trial:</strong> Ideal for growing agencies
                  </Typography>
                  <Typography variant="caption" className="text-slate-600 mt-1 block">
                    • Up to 15 clients • 75 reports per month • $99/month after trial
                  </Typography>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {clients.length < 15 && (
                <div className="text-center">
                  ...
                  >
                    + Add Another Client ({clients.length}/15)
                  </Button>
                </div>
              )}
