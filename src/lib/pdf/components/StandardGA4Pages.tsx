    ...
    <>
      ...
      <Page style={styles.page}>
        <ReportHeader
          ...
          subtitle={`Comprehensive website performance data for ${data.clientDomain} | ${data.reportPeriod.startDate} - ${data.reportPeriod.endDate}`}
      ...
      <Page style={styles.page}>
        <ReportHeader
          title="Analytics Breakdown & Performance"
          subtitle={`Detailed insights and device analytics for ${data.clientDomain}`}
          clientName={data.clientName}
          branding={data.branding}
        />
