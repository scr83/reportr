...
<div class="my-8">
  <a href="/signup" class="inline-block w-full md:w-auto px-8 py-4 text-lg font-bold text-purple-600 bg-white border-2 border-purple-600 rounded-lg hover:bg-purple-600 hover:text-white transition-all duration-300 text-center">
    Start Free Trial →
  </a>
</div>
...
For agencies looking to scale beyond 10-15 clients, Reportr becomes essential. Manual reporting simply doesn't scale, and generic reports hurt your professional image. Our [features](/features) page showcases exactly how Reportr can transform your agency's workflow.
...
<div class="my-8 p-6 bg-gray-50 rounded-lg text-center">
  <a href="/signup" class="inline-block w-full md:w-auto px-8 py-4 text-lg font-bold text-purple-600 bg-white border-2 border-purple-600 rounded-lg hover:bg-purple-600 hover:text-white transition-all duration-300 mb-4">
    Try Free for 14 Days →
  </a>
  <p class="text-sm text-gray-600 mt-2">✓ No credit card required  ✓ Setup in 5 minutes  ✓ Cancel anytime</p>
</div>
...
<div class="my-8 p-6 bg-purple-50 rounded-lg text-center">
  <a href="/signup" class="inline-block w-full md:w-auto px-8 py-4 text-lg font-bold text-purple-600 bg-white border-2 border-purple-600 rounded-lg hover:bg-purple-600 hover:text-white transition-all duration-300 mb-4">
    Start Your Free Trial Now →
  </a>
  <p class="text-sm text-gray-600 mt-2">14-day free trial • No credit card required • Full white-label access</p>
</div>
